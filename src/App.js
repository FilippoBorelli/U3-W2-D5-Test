...
function App() {
  ...
  return (
    <>
      <div className="container" style={{background: "rgb(0,212,255)",
background: "radial-gradient(circle, rgba(0,212,255,1) 0%, rgba(1,110,150,1) 53%, rgba(0,212,255,1) 100%)"}}>
      ...
      <span className="credit"><a href="https://github.com/FilippoBorelli">Filippo Borelli</a></span>
    </>
  );
}
